...
export default function PostCard8({ post }) {
    // console.log(post)
    // Format Date
                ...
                <div className="justify-start items-center gap-4 flex flex-col">
                    ...
                    <div className="p-4 flex-col gap-4 inline-flex items-center md:items-start">
                        ...
                        <h3 className="text-center md:text-start mb-4 md-mb-0">
                            <Link className="text-neutral-dark-950 dark:text-neutral-dark-950 text-lg font-bold leading-tight item-link" href={`/blog/${post?.id}`}>{post?.title}</Link>
                        </h3>
                    </div>
                </div>
            </div>
