...
export default function MobileMenu({ isMobileMenu, handleMobileMenu }) {
  return (
    <>
      <div
        className={`navbar-menu fixed top-0 left-0 z-50 w-full h-full bg-neutral-950 bg-opacity-30 ${
          isMobileMenu ? "" : "hidden"
        } `}
      >
            ...
            <div className="flex flex-col h-full">
              ...
              <ul className="py-6 mb-6 border-y border-neutral-300 dark:border-neutral-dark-300">
                <li className="has-children">
                  <Link className="menu-mobile-item" href="/">
                    Home
                  </Link>
                </li>
                <li className="has-children">
                  <Link className="menu-mobile-item" href="/providers-curriculum">
                    Providers Curriculum
                  </Link>
                </li>
                <li className="has-children">
                  <Link className="menu-mobile-item" href="/parents-curriculum">
                    Parents Curriculum
                  </Link>
                </li>
                <li className="has-children">
                  <Link
                    href="/blogs"
                    className="menu-mobile-item group-hover:border-white"
                  >
                    Blog
                  </Link>
                </li>
                <li className="has-children">
                  <Link href="/contact" className="menu-mobile-item">
                    Contact
                  </Link>
                </li>
              </ul>
              {/* <ul>
                <li className="has-children">
                  ...
                  <ul className="sub-menu">
                    <li>
                      <Link className="menu-mobile-sub-item" href="/">
                        Home page 01
                      </Link>
                    </li>
                    <li>
                      <Link className="menu-mobile-sub-item" href="/index-2">
                        Home page 02
                      </Link>
                    </li>
                    <li>
                      <Link className="menu-mobile-sub-item" href="/index-3">
                        Home page 03
                      </Link>
                    </li>
                  </ul>
                ...
                <li className="has-children">
                  ...
                  <ul className="sub-menu">
                    <li>
                      <Link href="/category" className="menu-mobile-sub-item">
                        Category 01
                      </Link>
                    </li>
                    <li>
                      <Link href="/category-2" className="menu-mobile-sub-item">
                        Category 02
                      </Link>
                    </li>
                    <li>
                      <Link href="/category-3" className="menu-mobile-sub-item">
                        Category 03
                      </Link>
                    </li>
                    <li>
                      <Link href="/category-4" className="menu-mobile-sub-item">
                        Category 04
                      </Link>
                    </li>
                    <li>
                      <Link href="/single" className="menu-mobile-sub-item">
                        Single 01
                      </Link>
                    </li>
                    <li>
                      <Link href="/single-2" className="menu-mobile-sub-item">
                        Single 02
                      </Link>
                    </li>
                  </ul>
                ...
                <li className="has-children">
                  ...
                  <ul className="sub-menu">
                    <li>
                      <Link href="/page-about" className="menu-mobile-sub-item">
                        About me
                      </Link>
                    </li>
                    <li>
                    ...
                    <li>
                      <Link href="/page-login" className="menu-mobile-sub-item">
                        Login
                      </Link>
                    </li>
                    <li>
                    ...
                    <li>
                      <Link href="/page-404" className="menu-mobile-sub-item">
                        Error 404
                      </Link>
                    </li>
                  </ul>
                ...
                <li>
                  <Link className="menu-mobile-item" href="/page-about">
                    About
                  </Link>
                </li>
                <li>
                  <Link className="menu-mobile-item" href="/page-contact">
                    Contact
                  </Link>
                </li>
              </ul> */}
              {/* <div className="flex flex-wrap flex-col mt-4">
                ...
                <p className="text-sm text-neutral-700 font-medium mb-4 leading-5">
                  Imagine waking up to a dose of positivity, lifestyle hacks,
                  and inspiration tailored just for you. That's what you get
                  when you subscribe!
                </p>
                <Link
                  href="/page-login"
