                    ...
                    <div className="container px-4">
                        <div className="flex flex-col lg:flex-row gap-8 items-center">
                            ...
                            <div className="lg:pl-8  lg:w-1/2">
                                <h1 className="text-9xl text-neutral-950 dark:text-neutral-dark-950 font-bold mb-2">404</h1>
                                <h6 className="text-5xl text-neutral-950 dark:text-neutral-dark-950 font-bold mb-2">Oops! We Can’t find
                                    that page</h6>
                                <p className="text-lg text-neutral-700 dark:text-neutral-dark-700 font-bold mb-12">Sorry, the page you
                                    are looking for doesn’t exits or has been moved. Try searching our site or <Link href="/" className="text-neutral-950 dark:text-neutral-dark-950">Back to Home</Link></p>
                                <div className="relative mb-8 lg:max-w-[400px]">
                                    <form >
                                        <div className="flex gap-4 mb-4 bg-neutral-0 dark:bg-neutral-dark-200 rounded-full p-1 pl-9 border border-neutral-300 dark:border-neutral-dark-300">
                                            <input className="flex-1 focus:outline-none transition duration-200 bg-transparent max-w-[175px] md:max-w-none" type="text" placeholder="Enter your key words" />
                                            <button className="min-w-12 size-12 rounded-full bg-primary-light-950 transition duration-200 flex items-center justify-center gap-2" type="submit">
                                    ...
                                    <div className="flex-col justify-start items-start gap-3 inline-flex mt-8">
                                        <div className="text-neutral-950 dark:text-neutral-dark-950 text-base font-bold">Suggested</div>
