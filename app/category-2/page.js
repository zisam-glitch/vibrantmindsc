...
export default async function Category2() {
    return (
        <>
            <Layout>
                <div>
                    ...
                    <section className="relative py-4 lg:py-12">
                        <div className="container px-4">
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-[30px]">
                                <div className="grid md:grid-cols-2 justify-start items-center gap-4 rounded-3xl overflow-hidden border-2 bg-neutral-0 dark:bg-neutral-dark-0 border-neutral-300 dark:border-neutral-dark-300 hover-up">
                                    <Link href="/single" className="rounded-2xl overflow-hidden">
                                        <img className="md:min-h-[340px] w-auto" src="/assets/imgs/pages/img-21.png" />
                                    </Link>
                                    <div className="flex flex-col justify-start items-start gap-4 p-8">
                                        ...
                                        <h4>
                                            <Link className="text-neutral-950 dark:text-neutral-dark-950 text-lg font-bold item-link" href="/single">Fashionable Bytes: Blending Style with Tech Savvy</Link>
                                        </h4>
                                        <p className="text-neutral-700 text-sm font-medium leading-snug dark:text-neutral-dark-300">
                                            Fecessitatibus maiores aut quo repellat dolore dolor. Ipsam iusto sit illo enim officia
                                            soluta qui.
                                        </p>
                                    </div>
                                </div>
                                <div className="grid md:grid-cols-2 justify-start items-center gap-4 rounded-3xl overflow-hidden border-2 bg-neutral-0 dark:bg-neutral-dark-0 border-neutral-300 dark:border-neutral-dark-300 hover-up">
                                    <Link href="/single" className="rounded-2xl overflow-hidden">
                                        <img className="md:min-h-[340px] w-auto" src="/assets/imgs/pages/img-22.png" />
                                    </Link>
                                    <div className="flex flex-col justify-start items-start gap-4 p-8">
                                        <div className="justify-start items-center gap-5 flex">
                                            <Link href="/category" className="px-3 py-[8px] bg-neutral-200 dark:bg-neutral-dark-200 rounded-3xl border border-neutral-200 dark:border-neutral-dark-300 justify-center items-center gap-2.5 flex">
                                            ...
                                            <div className="justify-start items-center gap-2 flex">
                                                <Link href="/author" className="w-9 h-9"><img className="w-9 h-9 rounded-3xl" src="/assets/imgs/avatar/avatar-03.png" /></Link>
                                                <div className="text-neutral-700 text-sm font-medium leading-none dark:text-neutral-dark-300">
                                                    <Link href="/author">Azumi</Link></div>
                                            </div>
                                        </div>
                                        <h4>
                                            <Link className="text-neutral-950 dark:text-neutral-dark-950 text-lg font-bold item-link" href="/single">Eco-Friendly Architecture: Building for a Sustainable Tomorrow</Link>
                                        </h4>
                                        <p className="text-neutral-700 text-sm font-medium leading-snug dark:text-neutral-dark-300">
                        ...
                        <div className="container px-4">
                            ...
                            <div className="flex flex-col md:flex-row justify-between gap-[58px]">
                                <div className="flex flex-col gap-16">
                                    <div className="grid md:grid-cols-1 lg:grid-cols-3 gap-x-[30px] gap-y-[65px] max-w-[850px]">
                                        <BlogPost showItem={12} style={6} startFrom={1} toEnd={24} showPagination />
                                    </div>
                                </div>
                                {/* SIDEVER */}
