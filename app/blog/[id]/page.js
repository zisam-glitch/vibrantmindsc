                ...
                <div className="flex flex-col lg:flex-row justify-between gap-[58px]">
                  <div className="post-content max-w-[850px]">
                    ...
                    <div className="single-content text-base font-medium text-neutral-950 dark:text-neutral-dark-950 leading-relaxed max-w-[850px]">
                      <img
                        src={`/assets/imgs/pages/${blogPost.img}`}
                      ...
                      <p>
                        In the vast canvas of existence, each individual carries
                        within themselves a unique palette of experiences,
                        emotions, and aspirations. This intricate tapestry,
                        woven with the threads of life, becomes the backdrop for
                        an extraordinary journey – a journey where creativity
                        takes center stage. "Brushstrokes of Life: A Creative
                        Journey Unveiled" is an exploration into the boundless
                        realms of human imagination and expression.
                      </p>
                      <h3>The Palette of Beginnings</h3>
                      <p>
                        At its core, creativity is the manifestation of the
                        human spirit, a vivid portrayal of the myriad hues that
                        define our existence. This journey begins with the first
                        strokes of infancy, where curiosity and wonder lay the
                        foundation for the artist within. As we traverse the
                        landscapes of childhood, adolescence, and adulthood, our
                        experiences become the pigments that color our canvases.
                      </p>
                      <blockquote className="block-quote relative pt-8 pb-8 pl-20 overflow-hidden mb-4">
                        <svg
                          ...
                          height={36}
                          viewBox="0 0 49 36"
                          className="fill-primary-light-950 dark:fill-primary-dark-950 opacity-20 absolute top-8 left-0"
                        >
                          <path
                        ...
                        <span className="font-normal text-xl block mb-4">
                          Within the strokes of our existence, creativity is the
                          heartbeat that transforms the mundane into a
                          masterpiece, revealing the extraordinary tapestry of
                          our shared human journey
                        </span>
                        <cite>-- Emily Jane</cite>
                      </blockquote>
                      <p>
                        The creative journey is a dynamic process, evolving with
                        every stroke, akin to an artist refining their
                        masterpiece. It encapsulates the courage to embrace
                        vulnerability and the resilience to learn from failures.
                        Each brushstroke signifies a lesson learned, a challenge
                        overcome, and a moment of self-discovery. These strokes
                        are not merely about creating art; they are about
                        forging connections with our inner selves and the world
                        around us.
                      </p>
                      <h4>Embracing Vulnerability and Resilience</h4>
                      <p>
                        The canvas of life is vast, encompassing various forms
                        of creativity – be it in the realms of visual arts,
                        literature, music, or even the art of living. It is a
                        celebration of the human ability to innovate, adapt, and
                        transform mundane moments into extraordinary
                        expressions. The dance of creativity unfolds differently
                        for each person, and the beauty lies in the diversity of
                        perspectives and interpretations.
                      </p>
                      <div className="grid md:grid-cols-2 gap-4 mt-8">
                        <img
                          src="/assets/imgs/pages/img-19.png"
                          className="rounded-3xl mb-8"
                          alt=""
                        />
                        <img
                          src="/assets/imgs/pages/img-24.png"
                          className="rounded-3xl mb-8"
                          alt=""
                        />
                      </div>
                      <p>
                        Creativity also serves as a powerful tool for
                        introspection and societal reflection. It has the
                        capacity to challenge norms, break barriers, and build
                        bridges. The unveiling of this creative journey is not
                        just a personal revelation but a shared experience that
                        resonates with others, fostering a sense of collective
                        understanding and empathy.
                      </p>
                      <h5>The Multifaceted Nature of Creativity</h5>
                      <p>
                        As we navigate the twists and turns of our creative
                        odyssey, it becomes apparent that the canvas is not
                        static. It is a living, breathing entity that mirrors
                        our growth, evolution, and the ever-changing landscapes
                        of our emotions. Embracing the impermanence of the
                        canvas allows us to appreciate the beauty in each
                        fleeting moment, savoring the essence of our creative
                        endeavors.
                      </p>
                    </div>
                    {/* Single Conttent */}
                      ...
                      <div className="flex flex-col md:flex-row justify-between gap-8">
                        <div>
                          ...
                          <div className="flex flex-wrap gap-2">
                            <Link
                              href="/category"
                              className="hover-up px-5 py-2 rounded-full border border-neutral-300 dark:border-neutral-dark-300  text-base font-medium hover:bg-neutral-300  hover:dark:bg-neutral-dark-300 transition-all duration-300"
                            >
                              Art
                            </Link>
                            <Link
                    ...
                    <div className="relative single-pagination mt-16 p-8 border border-neutral-300 dark:border-neutral-dark-300 rounded-xl text-lg font-bold text-neutral-950 dark:text-neutral-dark-950 leading-relaxed max-w-[850px]">
                      <div className="flex flex-col md:flex-row justify-between gap-8">
                        <div className="prev flex gap-4  hover-up">
                          <Link
                            href="/#"
                            className="text-neutral-950 rounded-full w-12 h-12 min-w-12 bg-primary-light-950 dark:bg-primary-dark-200 flex justify-center items-center"
                          >
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              width={18}
                          ...
                          <Link href="/single">
                            Fashionable Bytes: Blending Style with Tech Savvy
                          </Link>
                        </div>
                      ...
                      <div className="v-divider w-64 h-[1px] md:h-12 md:w-[1px] bg-neutral-300 dark:bg-neutral-dark-300 absolute top-1/2 left-10 md:left-1/2 md:top-10"></div>
                    </div>
                    {/* Single Comment form */}
                  ...
                  <div className="sidebar flex flex-col gap-12 md:max-w-[380px]">
                            ...
                            <div className="flex-col justify-start items-start gap-4 inline-flex">
                              <h4>
                                <Link
                                  ...
                                  href="/single"
                                >
                                  Globetrotting in Style: A Journey Through My
                                  Lens
                                </Link>
                              </h4>
                              <p className="text-neutral-700 text-sm font-medium leading-none dark:text-neutral-dark-700">
                    ...
                    <div className="about p-12 rounded-3xl bg-primary-light-300 dark:bg-primary-dark-300">
                      ...
                      <p className="font-medium text-neutral-950 dark:text-neutral-dark-950 mb-8 lg:mb-12 max-w-[350px]">
                        ...
                        finance, and many other aspects. Businesses aim to
                        generate
                      </p>
                      <div className="flex gap-2">
