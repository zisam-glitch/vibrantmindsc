                    ...
                    <div className="container px-4">
                        <div className="grid grid-cols-1 lg:grid-cols-2 items-start">
                            ...
                            <div className="mr-12 lg:pl-12">
                                ...
                                <p className="text-neutral-700 dark:text-neutral-dark-700 mb-16 font-medium text-2xl">Log in to the
                                    system to receive paid quality <br />articles and many other great functions</p>
                                <form >
